# AlphaSmart 3000 development branch

This branch contains active AlphaSmart 3000 emulator development based on MAME 0.289. See [`docs/as3k/STATUS.md`](docs/as3k/STATUS.md) for the current validated state, build notes, known gaps, reproducibility constraints, and the next development step.

The upstream MAME README follows unchanged below.
...
<img align="right" width="100" src="https://opensource.org/wp-content/uploads/2009/06/OSIApproved.svg "Repobeats analytics image")
...
Some parts of the code follow [Allman style](https://en.wikipedia.org/wiki/Indent_style#Allman); some parts follow [K&R style](https://en.wikipedia.org/wiki/Indent_style#K%26R_style) -- mostly depending on what was there previously. **Above all else, be consistent with what you modify, and keep whitespace changes to a minimum when modifying existing source.** For new code, the majority tends to prefer Allman style, so if you don't care much, use that.
